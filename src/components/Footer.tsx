...
const socialLogos = [
  {
    node: <InstagramIcon />,
    title: 'Instagram',
    href: 'https://instagram.com/stackhard.official',
  ...
  },
  {
    node: <LinkedInIcon />,
    title: 'LinkedIn',
    href: 'https://linkedin.com/company/stackhard',
...
const Footer = () => {
  ...
  return (
    <footer className="pt-8 border-t border-border bg-secondary/10">
      {/* Social loop strip */}
      <div
        className="w-full overflow-hidden mb-8 py-4 border-y border-border/30"
      ...
      >
        <LogoLoop
          ...
          scaleOnHover
          fadeOut
          fadeOutColor="hsl(220, 20%, 5%)"
          ariaLabel="Redes sociales de StackHard"
          style={{ color: 'hsl(24, 85%, 55%)' }}
        />
      </div>
